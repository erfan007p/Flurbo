...
This document provides guidelines for internationalization of the Flurbo Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `flurbo_en.ts` remains unchanged.
