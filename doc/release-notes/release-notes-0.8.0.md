Flurbo-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/flurbo/files/Flurbo/flurbo-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Flurbo
...
New/changed settings (command-line or flurbo.conf file)
--------------------------------------------------------
