Flurbo Core version 0.10.3 is now available from:

  <https://flurbo.org/bin/flurbo-core-0.10.3/>
...
(see https://github.com/flurbo/flurbo/pull/6793, as well as the 0.11.0
