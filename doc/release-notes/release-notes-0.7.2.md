Flurbo version 0.7.2 is now available from:
  http://sourceforge.net/projects/flurbo/files/Flurbo/flurbo-0.7.2
...
* Fix use-after-free problems in initialization and shutdown, the latter of
  which caused Flurbo-Qt to crash on Windows when exiting.
