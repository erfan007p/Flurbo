Flurbo Core version 0.9.4 is now available from:

  https://flurbo.org/bin/0.9.4/
...
this update is incompatible with the Flurbo system and could lead to consensus
forks.

Flurbo Core released binaries from https://flurbo.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~flurbo/+archive/ubuntu/flurbo
- A third-party or self-compiled Flurbo Core

upgrade to Flurbo Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
