Flurbo version 0.5.4 is now available for download at:
http://sourceforge.net/projects/flurbo/files/Flurbo/flurbo-0.5.4/
...
http://gitorious.org/flurbo/flurbod-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Flurbo-Qt notifications under Growl 1.3.
Increase required age of Flurbo-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxFlurbo properly when installing Flurbo-Qt over it. (Windows)
