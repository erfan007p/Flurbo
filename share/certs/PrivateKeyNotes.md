...
unlocked to sign the Flurbo-Qt.app bundle.
...
allowing somebody to distribute a Flurbo-Qt.app or flurbo-qt-setup.exe with a valid
...
that the flurbo-qt.exe file inside the installer had not been tampered with.
