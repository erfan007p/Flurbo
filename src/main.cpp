...
#if defined(NDEBUG)
# error "Flurbo cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Flurbo Signed Message:\n";
                              ...
                              std::vector<uint256>& vHashTxnToUncache)
{
...

    {
        ...
        {
            LogPrint("mempool", "replacing tx %s with %s for %s FLB additional fees, %d delta bytes\n",
