...
#ifndef FLURBO_QT_FLURBOUNITS_H
#define FLURBO_QT_FLURBOUNITS_H
...
/** Flurbo unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class FlurboUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit FlurboUnits(QObject *parent);

    /** Flurbo units.
      @note Source: https://en.flurbo.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        FLB,
...
typedef FlurboUnits::Unit FlurboUnit;

#endif // FLURBO_QT_FLURBOUNITS_H
