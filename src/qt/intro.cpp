...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", DEFAULT_CHOOSE_DATADIR))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/flurbo"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Flurbo Core"),
     ...
     * override -datadir in the flurbo.conf file in the default data directory
     * (to be consistent with flurbod behavior)
     */
    if(dataDir != getDefaultDataDirectory())
