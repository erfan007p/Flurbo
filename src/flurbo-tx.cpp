...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Flurbo Core flurbo-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  flurbo-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded flurbo transaction") + "\n" +
              "  flurbo-tx [options] -create [commands]   " + _("Create hex-encoded flurbo transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded flurbo transaction
