...
*/
	    ...
	    ( 24583, uint256S("0x00000000000002930acd23c2518db69fec6ee17d614abf8f02365556110a388f")),
            1508144393, //1504946923, // * UNIX timestamp of last checkpoint block
            1109,   // * total number of transactions between genesis and last checkpoint
...
public:
	...
	genesis = CreateGenesisBlock(1504946610, 789571, 0x2000000f, 1, 50 * COIN);
        ...
        vSeeds.clear();
	/*
        vSeeds.push_back(CDNSSeedData("flurbo.petertodd.org", "testnet-seed.flurbo.petertodd.org"));
        vSeeds.push_back(CDNSSeedData("bluematt.me", "testnet-seed.bluematt.me"));
        vSeeds.push_back(CDNSSeedData("flurbo.schildbach.de", "testnet-seed.flurbo.schildbach.de"));
	*/
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 0, uint256S("0x00000258baee7750addb491fa64387402da664e234ff77e7b8e3897aed4700cc")),
            1504946610,
            0,
            200
        };
...
public:
    CRegTestParams() {
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of
            ( 0, uint256S("0x662ff57202a75a233279b933528ff0cc8203115efe8a66dab682bb41db0b82a0"))
	    ( 1, uint256S("0x4d5e6a2ed178ee299f907e1e0bed78484c91a8bb38e082bd968224eb56494579")),
            0,
            0,
            0
        };
