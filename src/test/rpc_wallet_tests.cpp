// Copyright (c) 2013-2015 The Flurbo Core developers
...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CFlurboAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CFlurboAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey();
        demoAddress = CFlurboAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CFlurboAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CFlurboAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CFlurboAddress(arr[0].get_str()).Get() == demoAddress.Get());
