...
#ifndef FLURBO_TEST_SCRIPTNUM10_H
#define FLURBO_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Flurbo Core 0.10.0, for cross-comparison.
 */
public:
